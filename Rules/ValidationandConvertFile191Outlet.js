 ...
 */
export default async function ValidateAndConvertFile191Outlet(clientAPI) {
...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        const photoSection = sectionedTable.getSection('Section191UserInputForm');
        const photoControl = photoSection?.getControl('Section191TakePhoto');
        const attachments = photoControl?.getValue();

        const question = sectionedTable
            .getSection('Section191FormOutlet')
            .getControl('Section191Question')
            .getValue();
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section192FormOutlet').setVisible(true);
