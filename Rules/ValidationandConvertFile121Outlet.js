 ...
 */
export default async function ValidateAndConvertFile121Outlet(clientAPI) {
  ...
  try {
    ...
    const question = sectionedTable
      .getSection('Section121FormOutlet')
      .getControl('Section121QuestionOutlet')
      .getValue();
    ...
    // ✅ Show next section
    sectionedTable.getSection('Section122FormOutlet').setVisible(true);
