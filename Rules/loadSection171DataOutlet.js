export async function loadSection171DataOutlet(
    pageProxy,
    qcItem171,
    FormSectionedTable,
    attachments,
    ...
    try {
        ...
        const nextButton = Section171.getControl('Section172NextButton');
        if (nextButton) {
        ...
        if (flags?.next === false) {
            const Section171Form = FormSectionedTable.getSection('Section172FormOutlet');
            if (Section171Form) {
