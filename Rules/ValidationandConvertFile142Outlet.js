 ...
 */
export default async function ValidateAndConvertFile142Outlet(clientAPI) {
...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        const photoSection = sectionedTable.getSection('Section142UserInputImageOutlet');
        const photoControl = photoSection?.getControl('Section142TakePhotoOutlet');
        const attachments = photoControl?.getValue();

        const question = sectionedTable
            .getSection('Section142FormOutlet')
            .getControl('Section142Question')
            .getValue();
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section151FormOutlet').setVisible(true);
