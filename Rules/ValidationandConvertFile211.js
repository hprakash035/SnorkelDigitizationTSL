/**
 * Validate and convert file for Section 211
 * @param {IClientAPI} clientAPI
 */
export default async function ValidateAndConvertFile211(clientAPI) {
  ...
  try {
    ...
    const photoSection = sectionedTable.getSection('Section211UserInputForm');
    const photoControl = photoSection?.getControl('Section211TakePhoto');
    const attachments = photoControl?.getValue() || [];

    const question = "21.1 Snorkel fixing to the pallet at 4 points of wood"
    ...
    // ✅ Show next section
    sectionedTable.getSection('Section212Form').setVisible(true);
