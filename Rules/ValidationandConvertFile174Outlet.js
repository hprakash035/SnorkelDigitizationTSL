 ...
 */
export default async function ValidateAndConvertFile174Outlet(clientAPI) {
...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        const photoSection = sectionedTable.getSection('Section174UserInputImageOutlet');
        const photoControl = photoSection?.getControl('Section174TakePhotoOutlet');
        const attachments = photoControl?.getValue();

        const question = sectionedTable
            .getSection('Section174FormOutlet')
            .getControl('Section174Question')
            .getValue();
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section181FormOutlet').setVisible(true);
