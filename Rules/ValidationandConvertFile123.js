...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        await clientAPI.executeAction({
            Name: "/TRL_Snorkel_Digitization_TSL/Actions/AttachmentCreate123.action",
            Properties: {
                Properties: {
                    question: question,
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section122TestFormName').setVisible(true);
          sectionedTable.getSection('Section122TestForm').setVisible(true);
